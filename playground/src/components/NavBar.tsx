...
const NavBar = () => {
    return <>
        ...
        <div className="grid grid-cols-2 gap-4 bg-blue-700 p-6 hover:bg-blue-700">
                <NavLink className='font-semibold text-xl text-center hover:bg-blue-700' to="/examples/" 
                    style={({ isActive }) => ({
                    color: isActive ? '#fff' : '#fff',
                    background: isActive ? '#7b3fe4' : '#3b82f6',
                    })}>Playground</NavLink>
                <NavLink className='font-semibold text-xl text-center hover:bg-blue-700' to="/examples/instruction-set/"
                    style={({ isActive }) => ({
                    color: isActive ? '#fff' : '#fff',
                    background: isActive ? '#7b3fe4' : '#3b82f6',
                    })}>Instruction Set</NavLink>
        </div>
        </>
    };
