export const assemblerInstructions = [
  {
    ...
    instructions: [
      ...
      },
      {
        ...
        cycles: '9',
        notes:
          'Fetches the node value from the advice provider and runs a verification equivalent to mtree_verify, returning the value if succeeded.'
      },
      {
      ...
      },
      {
        ...
        cycles: '16',
        notes:
          'Merges two Merkle trees with the provided roots R (right), L (left) into a new Merkle tree with root M (merged). The input trees are retained in the advice provider.'
      },
      {
        ...
        cycles: '1',
        notes:
          'Verifies that a Merkle tree with root $R$ opens to node $V$ at depth $d$ and index $i$. Merkle tree with root $R$ must be present in the advice provider, otherwise execution fails.'
      }
    ]
  },
  {
  ...
  },
  {
    ...
    instructions: [
      ...
      },
      {
        ...
        cycles: '5',
        notes:
          '$b \\leftarrow \\begin{cases} 1, &amp; \\text{if}\\ a \\text{ is odd} \\ 0, &amp; \\text{otherwise}\\ \\end{cases}$'
      },
      {
        instruction: 'eqw \n - (15 cycles)',
        stackInput: '[A, B, ...]',
  ...
  },
  {
    ...
    instructions: [
      ...
      },
      {
        ...
        cycles: '3',
        notes:
          '$c1 \\leftarrow (a0 + a1) * (b0 + b1) \\mod p$ and \n $c0 \\leftarrow (a0 * b0) - 2 * (a1 * b1) \\mod p$'
      },
      {
        instruction: 'ext2neg \n - (4 cycles)   \n',
        stackInput: '',
      ...
      },
      {
        ...
        cycles: '11',
        notes:
          '$c \\leftarrow a * b^{-1}$ fails if $b=0$, where multiplication and inversion are as defined by the operations above'
      }
    ]
  },
  {
    ...
    instructions: [
      {
        ...
        cycles: '',
        notes:
          'Pushes a list of field elements onto the advice stack. The list is looked up in the advice map using word $K$ as the key. If offset $s$ is provided, the key is taken starting from item $s$ on the stack.'
      },
      {
        ...
        cycles: '',
        notes:
          'Pushes a list of field elements together with the number of elements onto the advice stack. The list is looked up in the advice map using word $K$ as the key. If offset $s$ is provided, the key is taken starting from item $s$ on the stack.'
      },
      {
        ...
        cycles: '',
        notes:
          'Pushes a node of a Merkle tree with root $R$ at depth $d$ and index $i$ from Merkle store onto the advice stack.'
      },
      {
        ...
        cycles: '',
        notes:
          'Pushes the result of u64 division $a / b$ onto the advice stack. Both $a$ and $b$ are represented using 32-bit limbs. The result consists of both the quotient and the remainder.'
      },
      {
      ...
      },
      {
        ...
        cycles: '',
        notes:
          'Pushes values onto the advice stack which are required for verification of a DSA with scheme specified by kind against the public key commitment $K$ and message $M$.'
      },
      {
        ...
        cycles: '',
        notes:
          'Pushes value onto the advice stack which is associated with key $K$ in a Sparse Merkle Tree with root $R$.'
      },
      {
        ...
        cycles: '',
        notes:
          'Reads words $data \\leftarrow mem[a] .. mem[b]$ from memory, and save the data into $advice_map[K] \\leftarrow data$.'
      },
      {
        ...
        cycles: '',
        notes:
          'Reads top two words from the stack, computes a key as $K \\leftarrow hash(A'
      },
      {
        ...
        cycles: '',
        notes:
          'Reads top three words from the stack, computes a key as $K \\leftarrow permute(C, A, B).digest$, and saves data into $advice_mpa[K] \\leftarrow [A, B]$.'
      }
    ]
  },
  {
  ...
  },
  {
    ...
    instructions: [
      ...
      },
      {
        ...
        cycles: '',
        notes:
          'Pushes a copy of the $n$th stack item onto the stack. dup and dup.0 are the same instruction. Valid for $n \\in {0, ..., 15}$'
      },
      {
        instruction: 'dupw.n \n - (4 cycles)',
        stackInput: '[ ..., A, ... ]',
        ...
        cycles: '4',
        notes:
          'Pushes a copy of the $n$th stack word onto the stack. dupw and dupw.0 are the same instruction. Valid for $n \\in {0, 1, 2, 3}$'
      },
      {
        instruction: 'swap.n \n - (1-6 cycles)',
        stackInput: '[a, ..., b, ... ]',
        ...
        cycles: '',
        notes:
          'Swaps the top stack item with the $n$th stack item. swap and swap.1 are the same instruction. Valid for $n \\in {1, ..., 15}$'
      },
      {
        instruction: 'swapw.n \n - (1 cycle)',
        stackInput: '[A, ..., B, ... ]',
        ...
        cycles: '1',
        notes:
          'Swaps the top stack word with the $n$th stack word. swapw and swapw.1 are the same instruction. Valid for $n \\in {1, 2, 3}$'
      },
      {
        instruction: 'swapdw \n - (1 cycle)',
        stackInput: '[D, C, B, A, ... ]',
        ...
        cycles: '1',
        notes:
          'Swaps words on the top of the stack. The 1st with the 3rd, and the 2nd with the 4th.'
      },
      {
        instruction: 'movup.n \n - (1-4 cycles)',
        stackInput: '[ ..., a, ... ]',
  ...
  },
  {
    ...
    instructions: [
      ...
      },
      {
        ...
        cycles: '37',
        notes:
          'Computes $b$ as a number of leading zeros of $a$. \n Undefined if $a \\ge 2^{32}$'
      },
      {
        instruction: 'u32ctz \n - (34 cycles)',
        stackInput: '',
        ...
        cycles: '34',
        notes:
          'Computes $b$ as a number of trailing zeros of $a$. \n Undefined if $a \\ge 2^{32}$'
      },
      {
        instruction: 'u32clo \n - (36 cycles)',
        stackInput: '',
        ...
        cycles: '36',
        notes:
          'Computes $b$ as a number of leading ones of $a$. \n Undefined if $a \\ge 2^{32}$'
      },
      {
        instruction: 'u32cto \n - (33 cycles)',
        stackInput: '',
        ...
        cycles: '33',
        notes:
          'Computes $b$ as a number of trailing ones of $a$. \n Undefined if $a \\ge 2^{32}$'
      }
    ]
  },
  {
