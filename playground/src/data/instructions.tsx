export const assemblerInstructions = [
    ...
    },
    {
        ...
        instructions: [
            ...
            stackOutput: "[a, ..., a, ... ]",
            cycles: "1-3 cycles",
            notes: "Pushes a copy of the $n$th stack item onto the stack. `dup` and `dup.0` are the same instruction. \n \n Valid for $n \\in \\{0, ..., 15\\}$"
            },
            {
            instruction: "dupw.*n*",
            stackInput: "[ ..., A, ... ]",
            stackOutput: "[A, ..., A, ... ]",
            cycles: "4 cycles",
            notes: "Pushes a copy of the $n$th stack word onto the stack. `dupw` and `dupw.0` are the same instruction. \n \n Valid for $n \\in \\{0, 1, 2, 3\\}$"
            },
            {
            instruction: "swap.*n*",
            stackInput: "[a, ..., b, ... ]",
            stackOutput: "[b, ..., a, ... ]",
            cycles: "1-6 cycles",
            notes: "Swaps the top stack item with the $n$th stack item. `swap` and `swap.1` are the same instruction. \n \n  Valid for $n \\in \\{1, ..., 15\\}$"
            },
            {
            instruction: "swapw.*n*",
            stackInput: "[A, ..., B, ... ]",
            stackOutput: "[B, ..., A, ... ]",
            cycles: "1 cycle",
            notes: "Swaps the top stack word with the $n$th stack word. `swapw` and `swapw.1` are the same instruction. \n \n  Valid for $n \\in \\{1, 2, 3\\}$"
            },
            {
            instruction: "movup.*n*",
            stackInput: "[ ..., a, ... ]",
    ...
    },
    {
        ...
        instructions: [
            ...
            "undefined": "ext{if}\\ a < 2^{32} \\ 0, & \\text{otherwise}\\ \\end{cases}$"
            },
            {
            ...
            stackOutput: "[A, ...]",
            cycles: "6 cycles",
            notes: "Fails if $\\exists\\ i \\in \\{0, 1, 2, 3\\} \\\ni a_i \\ge 2^{32}$"
            },
            {
            instruction: "u32cast",
            stackInput: "[a, ...]",
    ...
    },
    {
        ...
        instructions: [
            ...
            "undefined": "ext{if}\\ (a + b) \\ge 2^{32} \\ 0, & \\text{otherwise}\\ \\end{cases}$ \n \n Undefined if $max(a, b) \\ge 2^{32}$"
            },
            {
